                        ...
                        then
                          ...
                          if [[ -e /etc/openvpn/server.conf ]]; then
                              ...
                              if [[ "$resp" = @(s|S) ]]; then
                                ...
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP/Proxy: \033[1;37m$IP" ; echo -e "\033[1;32mUsername: \033[1;37m$username" ; echo -e "\033[1;32mPassword: \033[1;37m$password" ; echo -e "\033[1;32mExpire: \033[1;37m$gui" ; echo -e "\033[1;32mLimite: \033[1;37m$sshlimiter" ; echo "" || echo "Unable to create user!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
